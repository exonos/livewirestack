<div x-data="{ showMore: false }" class="mt-2 w-full">
    ...
    @endif
        {{--<button
                type="button"
                aria-expanded="true"
                aria-controls="taxonomyAttributes.f9dde7ac-b536-493d-ac13-2914188757f3-content-4303"
                ...
                style="text-align: start; text-decoration: none; margin-block: 0px; margin-inline: 0px; transition: none 0s ease 0s; inline-size: auto; padding-block: 0.5625rem; padding-inline: 0px; min-block-size: 2.75rem; box-shadow: none; justify-content: left;"
        >
            Mostrar menos<svg
