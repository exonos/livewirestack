<div x-cloak x-on:confirm.window="setConfirm($event)"
    ...
    <div x-show="open"
        ...
        <div class="mt-4 text-center md:mt-0 md:text-left">
            <p class="font-semibold" x-text="config.title">Are you Sure?</p>
            <p x-text="config.message"></p>
        </div>
        <div class="mt-4 text-center md:text-right md:flex md:justify-end">
            <button class="block w-full px-2 py-1 text-xs font-semibold text-red-700 bg-red-200 hover:bg-red-300 hover:ring-1 hover:ring-red-400 rounded-lg md:inline-block md:w-auto md:ml-2 md:order-2" @click="yesConfirm()">Yes</button>
            <button class="block w-full px-2 py-1 mt-4 text-xs font-semibold bg-gray-200 hover:bg-gray-300 hover:ring-1 hover:ring-gray-400 rounded-lg md:inline-block md:w-auto md:mt-0 md:order-1" @click="closeConfirm()">No</button>
        </div>
    </div>
</div>
