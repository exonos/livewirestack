<div x-cloak x-on:confirm.window="setConfirm($event)"
    ...
    <div x-show="open"
        ...
        <div class="flex items-center flex-wrap space-x-5 py-5 px-8 justify-end bg-white dark:bg-stone-800 border-t border-t-stone-200 dark:border-t-stone-700">
            ...
            <button  @click="yesConfirm()" type="button" class="focus:outline-none text-white bg-danger-700 hover:bg-danger-800 focus:ring-4 focus:ring-danger-300 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2 dark:bg-danger-600 dark:hover:bg-danger-700 dark:focus:ring-danger-900">
                Yes
            </button>
        </div>
    </div>
