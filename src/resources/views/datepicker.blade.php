                            ...
                            <template x-for="(day, dayIndex) in datePickerDaysInMonth" :key="dayIndex">
                                <div class="px-0.5 mb-1 aspect-square">
                                    <div
                                        ...
                                        :class="{
                                        'bg-blue-200': datePickerIsToday(day) == true,
                                        'text-gray-600 hover:bg-blue-200': datePickerIsToday(day) == false && datePickerIsSelectedDate(day) == false,
                                        'bg-blue-800 text-white hover:bg-opacity-75': datePickerIsSelectedDate(day) == true
                                    }"
