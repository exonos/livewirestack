                ...
                <div class="flex p-4">
                    <div class="flex-shrink-0">
                        ...
                        <div x-show="toast.type === 'error'">
                            <div class="inline-flex items-center justify-center flex-shrink-0 w-8 h-8 text-danger-500 bg-danger-100 rounded-lg dark:bg-danger-800 dark:text-danger-200">
                                <svg class="w-5 h-5" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 20">
