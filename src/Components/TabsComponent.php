...
use Exonos\Livewirestack\Traits\HasHooks;
use Exonos\LivewireStack\Traits\HasState;
...
abstract class TabsComponent extends Component implements TabForm
{
    ...
    {
        return view('livewirestack::tabs-footer');
    }
    ...
    {
        return view('livewirestack::tab-container', [
